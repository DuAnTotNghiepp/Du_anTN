    ...
    <div class="modal fade" id="showModal1" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <form action="{{route('admin.update',$model->id)}}" method="POST" class="tablelist-form" autocomplete="off">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-12">
                                ...
                                <div>
                                    <input type="checkbox" name="is_active" id="is_active" value="1" class="form-check-input" {{ isset($item) && $item->is_active ? 'checked' : '' }}>
