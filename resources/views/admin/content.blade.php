                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex align-items-center">
                                                <div class="me-3">
                                                    ...
                                                    <input type="date" id="start-date" class="form-control d-inline-block w-auto" name="start-date">
                                                </div>
                                                <div class="me-3">
                                                    <label for="end-date" class="me-2">Đến ngày:</label>
                                                    <input type="date" id="end-date" class="form-control d-inline-block w-auto" name="end-date">
                                                </div>
                                                <div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span id="income-total" class="counter-value">0</span>đ</h4>
                                            <a href="{{ route('orderRates.best-selling') }}" class="text-decoration-underline">Xem thu nhập</a>
                                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Số đơn hàng mới</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span id="order-count-new" class="counter-value">0</span></h4>
                                            <a href="{{ route('products.best-selling') }}"class="text-decoration-underline">Xem tất cả đơn hàng</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Số tài khoản mới</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span id="account-count" class="counter-value">0</span></h4>
                        ...
                        <div class="col-xl">
                            <div class="card">
                                <div class="card-header border-0 align-items-center d-flex">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-soft-primary btn-sm" data-time="1Y">1Năm</button>
                                    </div>
                                </div>
