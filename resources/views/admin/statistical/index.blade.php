    ...
    <div class="d-flex align-items-center mb-3">
        <form action="{{ route('products.best-selling') }}" method="GET" class="d-flex">
            <div class="me-3">
                ...
                <input type="date" id="start-date" class="form-control d-inline-block w-auto" name="start_date" value="{{ request('start_date') }}">
            </div>
            <div class="me-3">
                <label for="end-date" class="me-2">Đến ngày:</label>
                <input type="date" id="end-date" class="form-control d-inline-block w-auto" name="end_date" value="{{ request('end_date') }}">
            </div>
            <div>
                ...
                <div class="table-responsive table-card">
                    <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            @if($products->isEmpty())
                                <tr>
                                    <td colspan="3" class="text-center">Không có sản phẩm nào trong khoảng thời gian này.</td>
                                </tr>
                            @else
                                @foreach ($products as $product)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                    <img src="{{ asset($product->product_img_thumbnail) }}" alt="" class="img-fluid d-block"/>
                                                </div>
                                                <div>
                                                    <h5 class="fs-14 my-1">
                                        ...
                                        <td>
                                            <h5 class="fs-14 my-1 fw-normal">{{ number_format($product->product_price, 1) }} vnđ</h5>
                                        </td>
                                        <td>
                ...
                <div class="table-responsive table-card">
                    <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            @if($users->isEmpty())
                                <tr>
                                    <td colspan="3" class="text-center">Không có dữ liệu nào trong khoảng thời gian này.</td>
                                </tr>
                            @else
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="fs-14 my-1 fw-normal">{{ number_format($user->total_price, 1) }} vnđ</h5>
                                        </td>
                                        <td>
