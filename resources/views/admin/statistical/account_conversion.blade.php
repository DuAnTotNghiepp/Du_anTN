...
<div class="col-12">
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Tổng số đơn hàng và tỉ lệ hoàn thành & hủy</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <h5 class="mb-1">Tổng số đơn hàng: <strong>{{ $totalOrders }}</strong></h5>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var ctx = document.getElementById('orderRatesChart').getContext('2d');
            var orderRatesChart = new Chart(ctx, {
                type: 'pie',
                data: {
