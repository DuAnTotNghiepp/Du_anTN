                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="project-title-input" name="user_name" readonly
                                    value="{{ $orde->user_name }}" placeholder="Enter Tên Sản Phẩm" readonly disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="project-title-input" name="user_email" readonly
                                    value="{{ $orde->user_email }}" placeholder="Enter Tên Sản Phẩm" readonly disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="project-title-input" name="user_phone" readonly
                                    value="{{ $orde->user_phone }}" placeholder="Enter Tên Sản Phẩm" readonly disabled>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="project-title-input" name="total_price" readonly
                                    value="{{ $orde->total_price }}(VND)" placeholder="Enter Tên Sản Phẩm" readonly disabled>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Ghi Chú Của Khách Hàng</label>
                                <div id="ckeditor-classic">
                                    <textarea class="form-control" readonly disabled  readonly placeholder="Enter user_note" name="user_note" id="user_note" rows="3">{{ $orde->user_note }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3">
