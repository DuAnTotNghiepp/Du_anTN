            ...
            <div class="col-xxl-2 col-xl-3 col-lg-3 p-0 d-flex justify-content-between feature-banner-col">
                <div class="banner-feature-item position-relative">
                    <div class="b-feature-shape">
                        <img src="{{asset('assets/images/shapes/banner-feature-shape.png')}}" alt class="position-absolute">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-md banner-md1 position-relative">
                        <div class="banner-img">
                            <img src="{{asset('assets/images/banner/banner-md1.png')}}" alt="banner" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-md banner-md2 position-relative">
                        <div class="banner-img">
                            <img src="{{asset('assets/images/banner/banner-md2.png')}}" alt="banner" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-md banner-md3 position-relative">
                        <div class="banner-img">
                            <img src="{{asset('assets/images/banner/banner-md3.png')}}" alt="banner" class="img-fluid">
                        </div>
                        <div class="banner-md-content position-absolute">
                            <div class="banner-md-content-wrap">
                                <div class="banner-lavel">New Arrivals</div>
                        ...
                        <div class="tab-pane fade show active eg-product-tab-pane" id="eg-pills-one" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 ">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm1.png')}}" alt></a>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-2.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-3.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-4.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 ">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-5.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-6.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-7.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-8.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 ">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-9.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-10.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                                ...
                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-m d-flex align-items-center">
                                        <div class="product-img-m">
                                            <a href="product-details.html"><img src="{{asset('assets/images/product/pm-11.png')}}"
                                                                                alt></a>
                                            <div class="product-cart-icon"><a href="cart.html"><i
                                                        class="flaticon-shopping-cart"></i></a></div>
                                        </div>
                ...
                <div class="swiper-tranding-container overflow-hidden pb-30">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="product-card-xl">
                                <div class="product-img-xl">
                                    <a href="product-details.html"><img src="{{asset('assets/images/product/pxl-1.png')}}" alt
                                                                        class="img-fluid"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card-xl">
                                <div class="product-img-xl">
                                    <a href="product-details.html"><img src="{{asset('assets/images/product/pxl-2.png')}}" alt
                                                                        class="img-fluid"></a>
                                    <div class="product-actions-xl">
                                        <a href="#"><i class="flaticon-heart"></i></a>
                                        <a href="product-details.html"><i class="flaticon-search"></i></a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card-xl">
                                <div class="product-img-xl">
                                    <a href="product-details.html"><img src="{{asset('assets/images/product/pxl-3.png')}}" alt
                                                                        class="img-fluid"></a>
                                    <div class="product-actions-xl">
                                        <a href="#"><i class="flaticon-heart"></i></a>
                                        <a href="product-details.html"><i class="flaticon-search"></i></a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card-xl">
                                <div class="product-img-xl">
                                    <a href="product-details.html"><img src="{{asset('assets/images/product/pxl-4.png')}}" alt
                                                                        class="img-fluid"></a>
                                    <div class="product-actions-xl">
                                        <a href="#"><i class="flaticon-heart"></i></a>
                                        <a href="product-details.html"><i class="flaticon-search"></i></a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card-xl">
                                <div class="product-img-xl">
                                    <a href="product-details.html"><img src="{{asset('assets/images/product/pxl-7.png')}}" alt
                                                                        class="img-fluid"></a>
                                    <div class="product-actions-xl">
                                        <a href="#"><i class="flaticon-heart"></i></a>
                                        <a href="product-details.html"><i class="flaticon-search"></i></a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card-xl">
                                <div class="product-img-xl">
                                    <a href="product-details.html"><img src="{{asset('assets/images/product/pxl-6.png')}}" alt
                                                                        class="img-fluid"></a>
                                    <div class="product-actions-xl">
                                        <a href="#"><i class="flaticon-heart"></i></a>
                                        <a href="product-details.html"><i class="flaticon-search"></i></a>
                ...
                <div class="col-lg-12">
                    <div class="banner-xl-bg d-flex align-items-center position-relative">
                        <div class="banner-shapes">
                            <img src="{{asset('assets/images/shapes/b-xl-right.png')}}" alt class="position-absolute top-0 end-0">
                            <img src="{{asset('assets/images/shapes/b-xl-left.png')}}" alt class="position-absolute top0 bottom-0">
                        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl1.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl2.png')}}" alt class="hover-img">
                                            </a>
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl3.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl4.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                            </div>
                                            <div class="product-actions">
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl5.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl6.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                            </div>
                                            <div class="product-actions">
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl7.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl8.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl9.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl10.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                            </div>
                                            <div class="product-actions">
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl11.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl12.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                            </div>
                                            <div class="product-actions">
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl17.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl16.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                                <span class="new">New</span>
                                            </div>
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl-1.png')}}" alt>
                                            </a>
                                            <div class="product-lavels">
                                            </div>
                                            <div class="product-actions">
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl-1.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl11.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                            </div>
                                            <div class="product-actions">
                                ...
                                <div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="product-card-l">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/images/product/p-dbl-1.png')}}" alt>
                                                <img src="{{asset('assets/images/product/p-dbl15.png')}}" alt class="hover-img">
                                            </a>
                                            <div class="product-lavels">
                                            </div>
                                            <div class="product-actions">
                ...
                <div class="swiper-blog-container overflow-hidden">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog-card-m">
                                <div class="blog-img-m">
                                    <a href="blog-details.html"><img src="{{asset('assets/images/blog/bm-1.png')}}" alt></a>
                                ...
                                <div class="blog-content-m">
                                    <ul class="blog-info d-flex">
                                        <li class="blog-author">
                                            <img src="{{asset('assets/images/blog/blog-author1.png')}}" alt class="author-img">
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card-m">
                                <div class="blog-img-m">
                                    <a href="blog-details.html"><img src="/images/blog/bm-2.png" alt></a>
                                    <div class="blog-actions">
                                        <a href="#"><i class="flaticon-share"></i></a>
                                    </div>
                                </div>
                                <div class="blog-content-m">
                                    <ul class="blog-info d-flex">
                                        <li class="blog-author">
                                            <img src="/images/blog/blog-author1.png" alt class="author-img">
                                            <a href="#">Alex Avater</a>
                                        </li>
                                        <li class="blog-date">
                                            <i class="flaticon-time"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card-m">
                                <div class="blog-img-m">
                                    <a href="blog-details.html"><img src="/images/blog/bm-3.png" alt></a>
                                    <div class="blog-actions">
                                        <a href="#"><i class="flaticon-share"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card-m">
                                <div class="blog-img-m">
                                    <a href="blog-details.html"><img src="{{asset('assets/images/blog/bm-4.png')}}" alt></a>
                                    <div class="blog-actions">
                                        <a href="#"><i class="flaticon-share"></i></a>
                                    </div>
                                </div>
